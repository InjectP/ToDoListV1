...
extension ViewModel {
        ...
        Task { [weak self] in
            ...
            do {
                ...
                if var todosArray = self.todos?.todos {
                    ...
                    CoreDataManager.shared.saveOrUpdate(todos: todosArray)
                }
            } catch {
    ...
    func updateCompleted(id: Int) {
        ...
        CoreDataManager.shared.updateCompleted(id: id, completed: todos?.todos[index].completed ?? false)
        updateTaskCount()
    }
    ...
    func updateTodo(id: Int, newTitle: String, newText: String, dateEdited: String) {
        ...
        CoreDataManager.shared.updateTodo(id: id, newTitle: newTitle, newText: newText, dateEdited: dateEdited)
...
//        print(nextId)
    ...
    func addTodo(todo: Todo) {
        ...
        CoreDataManager.shared.saveOrUpdate(todos: todos?.todos ?? [])
        getAmountTask()
        updateTaskCount()
        todoIsLoaded = true
    }
    ...
    private func loadDataFromCoreData() {
        let todosArray = CoreDataManager.shared.fetchAllTodos()
